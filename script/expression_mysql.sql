...
(
  ...
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '执行器基本配置'
  ROW_FORMAT = DYNAMIC;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '执行器下面的表达式具体配置'
  ROW_FORMAT = DYNAMIC;
...
(
    `id`                     bigint                                                         NOT NULL AUTO_INCREMENT,
    `trace_log_id`           bigint                                                         NULL DEFAULT NULL COMMENT '追踪编号主键',
    `executor_id`            bigint                                                         NULL DEFAULT NULL COMMENT '执行器编号',
    `expression_config_id`   bigint                                                         NULL DEFAULT NULL COMMENT '表达式配置编号',
    `module_type`            varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NULL DEFAULT NULL COMMENT '模块类型: expression:表达式,function:函数',
    `expression_content`     varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '表达式内容',
    `expression_result`      tinyint                                                        NULL DEFAULT NULL COMMENT '表达式结果 0 失败 1成功',
    `debug_trace_content`    varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '调试信息',
    `expression_description` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT '表达式描述',
    `is_deleted`             tinyint                                                        NULL DEFAULT 0 COMMENT '状态 1已删除',
    `created`                datetime(0)                                                    NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
    `creator`                varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NULL DEFAULT NULL COMMENT '创建人',
    `updated`                datetime(0)                                                    NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
    `updater`                varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NULL DEFAULT NULL COMMENT '更新人',
    PRIMARY KEY (`id`) USING BTREE,
    INDEX `idx_trace_log_id` (`trace_log_id`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci
